...
allowed_urls_regex =
  System.get_env(
    ...
    "tiktok\\.com\\/(?:@[^/]+\\/(?:video|photo)\\/\\d+|t\\/[^/]+)|(?:vm|vt)\\.tiktok\\.com\\/[^/]+|twitter\\.com|facebook\\.com|instagram\\.com\\/(?:p|reel|reels|tv|stories)\\/[^/]+|threads\\.com|threads\\.net|coub\\.com|x\\.com|youtube\\.com\\/shorts"
  )
